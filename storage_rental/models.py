...
class User(AbstractUser):
    ...
    bookings = models.ManyToManyField('BookingRequest', related_name='users')

    groups = models.ManyToManyField(
        Group,
        verbose_name='groups',
        blank=True,
        related_name='storagerentalusers'  # add relatedname
    )
    user_permissions = models.ManyToManyField(
        Permission,
        verbose_name='user permissions',
        blank=True,
        related_name='storage_rental_users_permissions'  # add relatedname
    )
...
class Order(models.Model):
    ...
    class Meta:
        unique_together = ('storage_id', 'cell_id')
...
class Alert(models.Model):
    ...
    status = models.CharField(default='отправлено')
